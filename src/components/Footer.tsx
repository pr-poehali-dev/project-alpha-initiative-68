export function Footer() {
  const footerLinks = {
    "Возможности": ["Генерация статей", "Ключевые слова", "Проверка фактов", "Перелинковка", "Программное SEO", "Обратные ссылки", "JSON-LD схема"],
    "Продукт": ["Тарифы", "Как работает", "Интеграции", "Примеры статей", "Документация", "API", "Обновления"],
    "Компания": ["О нас", "Клиенты", "Карьера", "Новости", "Блог", "Кейсы", "Бренд"],
    "Ресурсы": ["Гайды по SEO", "Статус", "Для агентств", "Поддержка", "DPA", "Конфиденциальность", "Условия"],
    "Связаться": ["Контакты", "Сообщество", "Telegram", "VK", "YouTube"],
  }
